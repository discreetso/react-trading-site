        ...
        <div className="container">
            <div className="row p-5 mt-5 mb-5">
                <h1 className="fs-2 text-center">
                    We pioneered the discount broking model in Pakistan.
            ...
            style={{ lineHeight: '1.3', fontSize: '1.2em'}}>
                <div className="col-6 p-5">
                    <p>
                        ...
                        support, and technology. We named the company Zerodha, a combination of Zero and 
                ...
                <div className="col-6 p-5">
                    ...
                    <p>
                        <a href="https://www.rainmatter.com" style={{ textDecoration:'none' }}>Rainmatter</a>, 
                        our fintech fund and incubator, has invested in several fintech startups with 
                    ...
                    <p>
                        ...
                        initiatives to empower retail traders and investors. Rainmatter, our fintech
                        fund and incubator, has invested in several fintech startups with the goal of
                        growing the Indian capital markets. And yet, we are always up to something
                        new every day. Catch up on the latest updates on our blog or see what the
                        media is saying.
                    </p>
                </div>
            </div>
